...
import { getStudyRecommendations } from '@/app/actions';
import type { StudyRecommendation } from '@/app/actions';
                      ...
                      {needsAction ? (
                        <p className="mt-2 text-[12px] leading-5 text-muted-foreground">
                          {item.reason === 'falta-cobertura' ? (
                            ...
                            <>
                              <Target className="mr-1 inline h-3.5 w-3.5 text-amber-500 dark:text-amber-400" />
                              Tu promedio de acierto es del {item.promedioAciertoPorcentaje.toFixed(0)}%. Repasá los temas que más fallás.
                            </>
                          )}
                        </p>
                      ) : (
                        <p className="mt-2 text-[12px] leading-5 text-emerald-600 dark:text-emerald-400">
