...
function ClientLayoutInner({ children }: { children: React.ReactNode }) {
 ...
 <div className="inline-flex h-8 items-center gap-1.5 rounded-full border border-brand/20 bg-brand/10 px-2.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)]">
 ...
 className="absolute right-2 top-2 inline-flex min-h-[44px] min-w-[44px] items-center justify-center rounded-full border border-border bg-card/90 p-2 text-muted-foreground shadow-sm transition hover:border-input hover:text-foreground"
