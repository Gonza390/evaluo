...
export default function SimuladorExamen({
 ...
 <p className="text-[12px] font-semibold uppercase tracking-[0.18em] text-slate-500">Aciertos</p>
 ...
 <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
 <p className="text-[12px] font-semibold uppercase tracking-[0.18em] text-slate-500">Nota estimada</p>
 ...
 <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
 <p className="text-[12px] font-semibold uppercase tracking-[0.18em] text-slate-500">Nota</p>
 <p className={cn('mt-2 text-2xl font-bold', aprobado ? 'text-emerald-600' : 'text-amber-600')}>
 {nota.toFixed(1)}
 </p>
 </div>
 ...
 className="mt-2 text-base font-semibold leading-relaxed text-slate-900 sm:text-lg"
 >
 ...
 <div className="mt-6 rounded-xl border border-slate-100 bg-slate-50/70 p-3.5">
 ...
 <p className="mt-2 text-[12px] text-slate-500">de {formatTime(examDurationSeconds)}</p>
 ...
 <div className="fixed inset-x-0 bottom-0 z-40 border-t border-slate-200 bg-white px-2.5 pb-[max(env(safe-area-inset-bottom),0.45rem)] pt-2 shadow-[0_-8px_24px_rgba(15,23,42,0.08)] backdrop-blur lg:hidden">
