...
export const metadata: Metadata = {
  ...
  description:
    'Usá IA para transformar tus apuntes y PDFs en resúmenes, mapas mentales, flashcards y ejercicios. Estudiá y practicá el mismo material en Evaluo.',
  ...
  openGraph: {
    ...
    description:
      'Transformá tus propios materiales en resúmenes, mapas mentales, flashcards y ejercicios para estudiar y practicar.',
