    ...
    <div className="animate-page-enter min-h-full bg-white">
      <div className="w-full border-b border-[#E8EDF5] bg-white">
        <div className="mx-auto flex min-h-14 max-w-7xl items-center px-4 py-2.5 lg:px-8">
          <div className="h-4 w-52 animate-pulse rounded-full bg-white" />
        </div>
      </div>
      ...
      <div className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="grid grid-cols-3 gap-2 py-2.5 sm:flex sm:gap-6">
            ...
            <div className="h-11 w-full animate-pulse rounded-xl bg-white sm:w-40" />
            <div className="h-11 w-full animate-pulse rounded-xl bg-white sm:w-32" />
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-6 lg:px-8 lg:py-8">
        <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-2">
            <div className="h-8 w-60 animate-pulse rounded-full bg-white" />
          ...
          {Array.from({ length: 6 }).map((_, index) => (
            <div key={index} className="surface-card animate-pulse p-4 sm:p-5">
              <div className="flex items-start gap-4">
                <div className="h-[148px] w-[112px] rounded-[22px] bg-white" />
                <div className="min-w-0 flex-1 space-y-3">
                  <div className="h-5 w-3/4 rounded-full bg-white" />
                  <div className="h-4 w-1/3 rounded-full bg-white" />
              ...
              <div className="mt-6 flex gap-3">
                ...
                <div className="h-10 w-28 rounded-2xl bg-white" />
              </div>
            </div>
          ))}
        </div>
