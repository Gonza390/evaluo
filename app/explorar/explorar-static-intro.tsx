  ...
  return (
    <section className="surface-panel animate-surface-reveal overflow-hidden px-4 py-4 sm:px-6 sm:py-7">
      <div className="max-w-3xl">
        <div className="inline-flex items-center gap-2 rounded-full bg-indigo-50 px-3 py-1.5 text-[12px] font-bold uppercase tracking-[0.18em] text-indigo-600 dark:bg-indigo-500/15 dark:text-indigo-300">
          <Sparkles className="h-3.5 w-3.5" />
          Explorar Evaluo
        </div>
        <h1 className="mt-3 text-[1.5rem] font-bold tracking-[-0.05em] text-slate-950 dark:text-slate-100 sm:mt-4 sm:text-[2.6rem]">
          Encuentra tu universidad o tu carrera y entra más rápido a estudiar.
        </h1>
        <p className="mt-2 max-w-2xl text-[13px] leading-6 text-slate-500 dark:text-slate-400 sm:mt-3 sm:text-base sm:leading-7">
      ...
      <div className="mt-4 grid gap-3 lg:grid-cols-2">
        <div className="rounded-[var(--radius-card)] border border-indigo-100 bg-indigo-50/70 px-4 py-3.5 dark:border-indigo-500/30 dark:bg-indigo-500/10">
          <p className="text-[12px] font-bold uppercase tracking-[0.18em] text-indigo-600 dark:text-indigo-300">
            Entrá más rápido
          </p>
          <p className="mt-1.5 text-[13px] leading-5 text-slate-700 dark:text-slate-300 sm:text-sm sm:leading-6">
            Si ya sabés tu carrera, entrá directo a sus materias y evitá pasar por pantallas
            intermedias.
          </p>
        </div>
        <div className="rounded-[var(--radius-card)] border border-slate-200 bg-white px-4 py-3.5 dark:border-slate-800 dark:bg-slate-900">
