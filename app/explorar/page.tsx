...
export default async function ExplorarPage({ searchParams }: ExplorarPageProps) {
  ...
  return (
    <div className="animate-page-enter mx-auto w-full max-w-6xl overflow-x-hidden px-4 pb-8 sm:px-6 sm:pb-10 [&_input]:shadow-none [&_.surface-card]:rounded-none [&_.surface-card]:border-x-0 [&_.surface-card]:border-t-0 [&_.surface-card]:border-b [&_.surface-card]:border-slate-200/90 [&_.surface-card]:bg-transparent [&_.surface-card]:shadow-none [&_.surface-card:hover]:translate-y-0 [&_.surface-card:hover]:border-indigo-200 [&_.surface-card:hover]:shadow-none [&_.surface-panel]:shadow-none">
      <ExplorarStaticIntro />
