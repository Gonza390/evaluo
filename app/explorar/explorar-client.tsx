...
export function ExplorarClient({ initialData }: { initialData: ExplorarData }) {
 ...
 <span className="inline-flex max-w-full items-center rounded-full border border-indigo-100 bg-indigo-50 px-3 py-1 text-[12px] font-bold uppercase tracking-[0.16em] text-indigo-600">
