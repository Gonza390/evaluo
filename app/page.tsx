...
const steps = [
  ...
  },
  {
    ...
    description: 'Hacés modelos de parcial cronometrados con el formato y la dificultad de un examen, para medir tu confianza antes del examen.',
  },
];
...
const features = [
  ...
  },
  {
    ...
    description: 'Cronómetros, ponderación y estructura similares a los de un parcial universitario. Entrená con la presión del tiempo antes de rendir.',
  },
  {
    icon: Target,
    title: 'Contenido específico',
    description: 'Focalizá tu estudio en los temas relevantes. En Evaluo el contenido se organiza según el programa de tu propia universidad.',
  },
  {
    icon: Brain,
  ...
  return (
    <div className="mt-6 flex flex-wrap justify-center gap-3">
      {argentinianUnis.map((uni) => {
        ...
        const className =
          'inline-flex items-center rounded-xl border border-slate-200/80 bg-white px-4 py-2 text-xs font-bold text-slate-700 dark:text-slate-200 shadow-sm transition hover:border-indigo-400 hover:text-indigo-600 hover:scale-[1.03] dark:border-slate-700 dark:bg-slate-900 dark:hover:border-indigo-500';

        return uniId ? (
          <Link key={uni.name} href={`/universidad/${uniId}`} title={uni.longName} className={className}>
            {content}
          </Link>
        ) : (
...
export default function Home() {
  ...
  return (
    <div className="animate-page-enter w-full overflow-x-clip bg-white text-slate-900 selection:bg-indigo-100 selection:text-indigo-900 dark:bg-[#0b1220] dark:text-slate-100 dark:selection:bg-indigo-900 dark:selection:text-white">
      ...
      {/* --- HEADER & HERO SECTION --- */}
      <section className="relative overflow-hidden border-b border-slate-100 bg-[radial-gradient(circle_at_top_right,rgba(99,102,241,0.14),transparent_35%),radial-gradient(circle_at_top_left,rgba(37,99,235,0.08),transparent_25%),linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] dark:border-slate-800 dark:bg-[radial-gradient(circle_at_top_right,rgba(99,102,241,0.12),transparent_35%),radial-gradient(circle_at_top_left,rgba(37,99,235,0.1),transparent_25%),linear-gradient(180deg,#0b1220_0%,#101b36_100%)]">
        ...
        <div className="mx-auto w-full max-w-[1240px] px-4 pb-12 pt-3 sm:px-8 lg:px-10 lg:pb-24">
          ...
          {/* Header / Navbar */}
          <header className="animate-surface-reveal flex h-13 items-center justify-between gap-2 rounded-2xl border-b border-slate-200/50 bg-white/70 px-3 shadow-sm backdrop-blur-md sm:h-16 sm:gap-4 sm:px-6 dark:border-slate-800 dark:bg-slate-950/70">
            <Link href="/" className="flex items-center gap-2 text-2xl font-bold tracking-[-0.04em] text-foreground">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-brand to-brand-2 text-white shadow-md">
                <GraduationCap className="h-5 w-5" />
              </div>
              <span>Evaluo</span>
            </Link>

            <nav className="hidden items-center gap-7 text-xs font-semibold text-slate-500 dark:text-slate-400 md:flex">
              <a href="#como-funciona" className="transition hover:text-indigo-600 dark:text-slate-300 dark:hover:text-indigo-400">Cómo funciona</a>
              <a href="#features" className="transition hover:text-indigo-600 dark:text-slate-300 dark:hover:text-indigo-400">Qué encontrás</a>
              <a href="#comparativa" className="transition hover:text-indigo-600 dark:text-slate-300 dark:hover:text-indigo-400">Comparación</a>
              <a href="#demo" className="transition hover:text-indigo-600 dark:text-slate-300 dark:hover:text-indigo-400">Demo interactiva</a>
                            <a href="#faq" className="transition hover:text-indigo-600 dark:text-slate-300 dark:hover:text-indigo-400">Preguntas</a>
            </nav>

            <div className="flex items-center gap-2 sm:gap-3">
              <ThemeToggle />
              <Link href="/login" className="hidden min-h-[44px] items-center px-3 text-xs font-bold text-slate-700 dark:text-slate-200 transition hover:text-indigo-600 sm:inline-flex dark:text-slate-300 dark:hover:text-indigo-400">
                Ingresar
              </Link>
              <TrackedLink
                href={primaryHref}
                ...
                className="hidden h-9 items-center justify-center rounded-xl bg-gradient-to-r from-brand to-brand-2 px-2.5 text-[12px] font-bold text-white shadow-[0_8px_20px_rgba(37,99,235,0.18)] transition hover:translate-y-[-1px] hover:shadow-[0_12px_24px_rgba(37,99,235,0.22)] sm:inline-flex sm:px-4 sm:text-xs"
              >
          ...
          <div className="grid items-center gap-8 pt-8 sm:pt-14 lg:grid-cols-[1.1fr_0.9fr] lg:gap-12 lg:pt-16">
            ...
            <div className="animate-surface-reveal flex flex-col items-start text-left">
              <div className="inline-flex items-center gap-2 rounded-full bg-indigo-50/80 px-3 py-1.5 text-[12px] font-bold text-indigo-700 ring-1 ring-indigo-200/50 backdrop-blur-sm sm:px-3.5 sm:text-xs dark:bg-indigo-500/15 dark:text-indigo-300 dark:ring-indigo-500/30">
                <Sparkles className="h-4 w-4 text-indigo-600" />
                <span>Estudiá con inteligencia, aprobá con confianza</span>
              </div>

              <h1 className="mt-4 text-[2.2rem] font-bold leading-[1.02] tracking-[-0.05em] text-foreground sm:mt-5 sm:text-5xl lg:text-[62px]">
                Todo lo que necesitás para aprobar tus parciales, <span className="bg-gradient-to-r from-brand to-brand-2 bg-clip-text text-transparent">en un solo lugar</span>.
              </h1>

              <p className="mt-4 max-w-[560px] text-[13px] leading-6 text-slate-600 dark:text-slate-400 sm:mt-5 sm:text-base sm:leading-8">
                Encontrá tu universidad, estudiá con resúmenes claros y practicá con simuladores de examen de tus materias. Sin PDFs caóticos ni ChatGPT genérico.
              </p>
              ...
              <div className="mt-6 flex w-full flex-col gap-2.5 sm:mt-8 sm:flex-row sm:gap-4">
                <TrackedLink
                  ...
                  className="inline-flex h-12 items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-brand to-brand-2 px-5 text-sm font-bold text-white shadow-[0_12px_28px_rgba(37,99,235,0.22)] transition hover:translate-y-[-1px] hover:shadow-[0_16px_32px_rgba(37,99,235,0.26)] sm:h-13 sm:px-8"
                >
                ...
                <TrackedLink
                  ...
                  className="inline-flex h-12 items-center justify-center rounded-2xl border border-slate-200 bg-white px-5 text-sm font-bold text-slate-700 dark:text-slate-200 shadow-[0_6px_20px_rgba(0,0,0,0.03)] transition hover:bg-slate-50 hover:translate-y-[-1px] sm:h-13 sm:px-8 dark:border-slate-700 dark:bg-slate-900 dark:hover:bg-slate-800 dark:shadow-none"
                >
                  Crear cuenta gratis
                </TrackedLink>
              </div>
              ...
              <div className="mt-6 grid w-full gap-3 border-t border-slate-100 pt-5 text-[12px] font-semibold text-slate-500 dark:text-slate-400 sm:mt-8 sm:flex sm:flex-wrap sm:gap-4 sm:pt-6 sm:text-xs">
            ...
            <div className="relative animate-surface-reveal block" style={{ animationDelay: '100ms' }}>
              ...
              <div className="w-full rounded-2xl border border-slate-200 bg-slate-950 p-3 shadow-[0_28px_60px_rgba(15,23,42,0.15)] relative overflow-hidden">
                ...
                {/* Header Mockup */}
                <div className="flex items-center justify-between border-b border-slate-800 bg-slate-900/60 rounded-xl px-4 py-2.5 mb-3 text-[12px]">
                ...
                <div className="px-3 pb-2.5 border-b border-slate-900 mb-3 flex items-center justify-between gap-3">
                  <span className="text-[12px] text-white/50 shrink-0 font-bold">Pregunta 9 de 20</span>
                  <div className="h-1.5 w-full rounded-full bg-slate-800 overflow-hidden">
                    <div className="h-full w-[45%] bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full" />
                  </div>
                  <span className="text-[12px] text-white/80 shrink-0 font-bold">45%</span>
                </div>

                {/* Question Area */}
                <div className="p-3">
                  <div className="flex gap-2">
                    <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-lg bg-indigo-500/10 text-indigo-400 text-[12px] font-bold">
                      ?
                    </div>
                  ...
                  <div className="mt-4 rounded-xl border border-indigo-500/20 bg-indigo-950/40 p-3.5 border-t-2 border-t-indigo-500">
                    <div className="flex items-center gap-1.5 mb-1.5">
                      ...
                      <span className="text-[12px] font-bold text-indigo-200">Explicación Paso a Paso &bull; Exclusivo Evaluo:</span>
                    </div>
              ...
              <div className="absolute -bottom-5 -left-5 z-20 hidden rounded-2xl border border-white/10 bg-white/95 dark:bg-slate-900/95 px-4 py-3 shadow-lg backdrop-blur sm:block">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-[12px] font-bold text-slate-800 dark:text-slate-100">Cátedras locales</p>
                    <p className="text-[8px] text-slate-500 dark:text-slate-400 leading-3">UBA, UTN, UNC, UNLP, UADE y más.</p>
                  </div>
                </div>
              </div>

              <div className="absolute -top-5 -right-5 z-20 hidden rounded-2xl border border-white/10 bg-white/95 dark:bg-slate-900/95 px-4 py-3 shadow-lg backdrop-blur sm:block">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-[12px] font-bold text-slate-800 dark:text-slate-100">Preparado específico</p>
                    <p className="text-[8px] text-slate-500 dark:text-slate-400 leading-3">Con el formato de un examen.</p>
                  </div>
                </div>
              </div>
      ...
      {/* --- TRUST SECTION --- */}
      <section className="bg-slate-50 border-b border-slate-100 py-10 sm:py-12 dark:bg-slate-950/50 dark:border-slate-800">
        <div className="mx-auto w-full max-w-[1240px] px-6 sm:px-8 lg:px-10">
          
          <div className="grid grid-cols-2 gap-3 sm:gap-6 lg:grid-cols-4">
            {trustSignals.map((signal) => (
              <div key={signal} className="flex items-center rounded-2xl border border-slate-200/60 bg-white p-4 shadow-sm transition hover:shadow-md dark:border-slate-800 dark:bg-slate-900">
                <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-indigo-50 text-indigo-600 dark:bg-indigo-500/15 dark:text-indigo-300">
                  <CheckCircle2 className="h-5 w-5" />
                </span>
                <span className="ml-3 text-xs font-semibold leading-5 text-slate-700 dark:text-slate-200 sm:text-sm">{signal}</span>
              </div>
            ))}
          </div>
      ...
      <section id="como-funciona" className="py-16 sm:py-24">
        <div className="mx-auto w-full max-w-[1240px] px-6 sm:px-8 lg:px-10">
          ...
          <div className="mx-auto max-w-3xl text-center">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-indigo-50 px-3.5 py-1 text-xs font-bold text-indigo-700 dark:bg-indigo-500/15 dark:text-indigo-300">
              <ListFilter className="h-3.5 w-3.5" />
              Paso a paso
            </span>
            <h2 className="mt-4 text-3xl font-bold tracking-tight text-foreground sm:text-4xl lg:text-[40px]">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {steps.map((step, index) => {
              ...
              return (
                <article
                  key={step.title}
                  className="relative flex flex-col justify-between rounded-2xl border border-slate-100 bg-white p-6 dark:border-slate-800 dark:bg-slate-900 shadow-[0_8px_20px_rgba(0,0,0,0.02)] transition hover:border-indigo-300 hover:shadow-md group"
                >
                  ...
                  <div>
                    <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-brand to-brand-2 text-white shadow-md">
                    ...
                    <div className="mt-6 flex items-center gap-2">
                      ...
                      <h3 className="text-[15px] font-bold text-slate-800 dark:text-slate-100 tracking-tight group-hover:text-indigo-600 transition-colors">
                        {step.title}
                      </h3>
                    </div>
      ...
      <section id="features" className="bg-slate-50/60 border-y border-slate-100 py-16 sm:py-24 dark:bg-slate-950/40 dark:border-slate-800">
        <div className="mx-auto w-full max-w-[1240px] px-6 sm:px-8 lg:px-10">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feat) => {
              ...
              return (
                <article
                  key={feat.title}
                  className="rounded-2xl border border-slate-100 bg-white p-6 dark:border-slate-800 dark:bg-slate-900 shadow-sm transition-all hover:border-indigo-300 hover:-translate-y-1 hover:shadow-md"
                >
                  ...
                  <h3 className="mt-5 text-[15px] font-bold text-slate-800 dark:text-slate-100 tracking-tight">
                    {feat.title}
                  </h3>
                  <p className="mt-3 text-xs leading-5 text-slate-600 dark:text-slate-400">
                    {feat.description}
      ...
      <section id="comparativa" className="py-16 sm:py-24">
        <div className="mx-auto w-full max-w-[1240px] px-6 sm:px-8 lg:px-10">
          ...
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl lg:text-[40px]">
          ...
          <div className="mt-12 grid gap-8 lg:grid-cols-2 items-stretch">
            ...
            {/* The Chaos Column */}
            <div className="rounded-3xl border border-red-100 bg-red-50/20 p-6 md:p-8 flex flex-col justify-between shadow-sm dark:border-red-900/50 dark:bg-red-950/20">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full bg-red-100/70 px-3.5 py-1.5 text-xs font-bold text-red-700 dark:bg-red-500/15 dark:text-red-300">
                  <X className="h-4 w-4 shrink-0" />
                  <span>El caos tradicional de fotocopiadora y chat</span>
                </div>
                <p className="mt-4 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Estudiar a la vieja escuela</p>
                
                <ul className="mt-6 space-y-4">
                  {comparison.chaos.map((item, idx) => (
                    <li key={idx} className="flex items-start gap-3 text-xs leading-5 text-slate-600 dark:text-slate-400">
              ...
              <div className="mt-8 rounded-2xl bg-red-50 p-4 border border-red-100 text-[12px] text-red-800 leading-5 dark:bg-red-950/40 dark:border-red-900/50 dark:text-red-200">
            ...
            {/* The Evaluo Column */}
            <div className="rounded-3xl border border-indigo-200 bg-[linear-gradient(135deg,rgba(99,102,241,0.03)_0%,rgba(37,99,235,0.03)_100%)] p-6 md:p-8 flex flex-col justify-between shadow-md relative overflow-hidden dark:border-indigo-800/60 dark:bg-[linear-gradient(135deg,rgba(99,102,241,0.08)_0%,rgba(37,99,235,0.08)_100%)]">
              <div className="absolute top-0 right-0 h-40 w-40 rounded-full bg-indigo-500/5 blur-3xl" />
              
              <div>
                <div className="inline-flex items-center gap-2 rounded-full bg-indigo-100 px-3.5 py-1.5 text-xs font-bold text-indigo-700 dark:bg-indigo-500/15 dark:text-indigo-300">
                  <Check className="h-4 w-4 shrink-0" />
                  <span>El Método Evaluo centralizado</span>
                </div>
                <p className="mt-4 text-xs font-bold text-indigo-700 uppercase tracking-wider dark:text-indigo-300">Estudiar con Evaluo</p>
                
                <ul className="mt-6 space-y-4">
                  {comparison.evaluo.map((item, idx) => (
                    <li key={idx} className="flex items-start gap-3 text-xs leading-5 text-slate-700 dark:text-slate-200 font-medium">
              ...
              <div className="mt-8 rounded-2xl bg-indigo-600 p-5 text-[12px] text-white leading-5 shadow-lg">
      ...
      <section id="demo" className="bg-slate-50 py-16 sm:py-24 dark:bg-slate-950/40">
        <div className="mx-auto w-full max-w-[1240px] px-6 sm:px-8 lg:px-10">
      ...
      {/* --- FAQ SECTION --- */}
      <section id="faq" className="bg-slate-50 py-16 sm:py-24 border-t border-slate-100 dark:bg-slate-950/40 dark:border-slate-800">
        <div className="mx-auto w-full max-w-[1240px] px-6 sm:px-8 lg:px-10">
      ...
      {/* --- CTA FINAL --- */}
      <section className="py-16 sm:py-24 bg-white dark:bg-[#0b1220]">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-[radial-gradient(circle_at_top_right,rgba(99,102,241,0.08),transparent_40%),radial-gradient(circle_at_bottom_left,rgba(37,99,235,0.08),transparent_40%),linear-gradient(180deg,#050B2C_0%,#0F1B3D_100%)] p-8 md:p-14 text-center shadow-xl">
            ...
            <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
              ...
              <p className="mt-4 max-w-xl text-xs sm:text-sm leading-6 text-white/80">
                Unite a miles de estudiantes universitarios de Argentina que preparan sus parciales con orden, practicidad y la estructura de sus materias.
              </p>
              ...
              <div className="mt-8 flex flex-col w-full max-w-md gap-3 sm:flex-row sm:justify-center">
                <TrackedLink
                  ...
                  className="inline-flex h-13 items-center justify-center gap-2 rounded-2xl bg-white px-6 text-sm font-bold text-slate-900 shadow-md hover:bg-slate-50 transition hover:translate-y-[-1px] dark:bg-slate-900 dark:text-white dark:hover:bg-slate-800 dark:shadow-none"
                >
                ...
                <TrackedLink
                  ...
                  className="inline-flex h-13 items-center justify-center rounded-2xl bg-gradient-to-r from-brand to-brand-2 px-6 text-sm font-bold text-white shadow-lg shadow-indigo-950/40 transition hover:translate-y-[-1px] hover:shadow-indigo-950/60"
                >
                  Crear cuenta gratis
                </TrackedLink>
              </div>
