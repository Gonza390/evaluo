...
export async function obtenerAdquisicionAdministrador(rangeDays = 30): Promise<{
  success: boolean;
  ...
  try {
    ...
    return {
      success: false,
      message: error instanceof Error ? error.message : 'No se pudo cargar la adquisición.',
    };
  }
}
