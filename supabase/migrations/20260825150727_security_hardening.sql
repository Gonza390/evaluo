...
alter function public.set_student_materials_updated_at() set search_path = public;
alter function public.set_student_material_feedback_updated_at() set search_path = public;
alter function public.set_study_calendar_events_updated_at() set search_path = public;
alter function public.set_student_material_summaries_updated_at() set search_path = public;
alter function public.set_student_material_glossaries_updated_at() set search_path = public;
alter function public.asignar_materias_globales() set search_path = public;
alter function public.set_student_material_flashcard_progress_updated_at() set search_path = public;
alter function public.set_student_material_ai_usage_updated_at() set search_path = public;
